                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editassets/{{$item->id}}" type="button" class="btn btn-warning">Edit</a>
                                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalCenter">Delete</button>
                                                    <!-- <a href="deleteasset/{{$item->id}}" type="button" class="btn btn-danger">Delete</a> -->
                                                </td>
                                            </tr>
                                            @endforeach
                                            <!-- modal -->
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <a href="deleteasset/{{$item->id}}" class="btn btn-danger">Delete</a>
                                        </tbody>
                                    </table>
                                </div>
                            </div>
